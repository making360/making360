...
{\large Oops! You hit record on one of the cameras by accident. 

 \par}

It’s easy to trigger one or two of the cameras and multiple times. This offsets the camera take numbers from each other and makes it a headache during ingestion. For example, after take 01 you triggered camera 1 by accident. After the next take, camera 1 will be  at 03 files but the rest of the cameras will say 02. If you triggered different cameras more than once, things start getting more confusing!

\imgA{1.5}{20/misfire1}
\imgA{1.5}{20/misfire2}
...
\imgA{1.5}{20/misfire3}
\imgA{1.5}{20/misfire4}
