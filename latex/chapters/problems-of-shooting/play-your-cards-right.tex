...
(You need the cards with the fastest read/write speeds because when you shoot with a high resolution video mode on the GoPro cameras, then you are obiviously dumping alot of data onto the memory card! So if you buy a knockoff memory card and the write speeds aren't up to snuff, then the camera buffer will fill up and will stop recording prematurely!)
