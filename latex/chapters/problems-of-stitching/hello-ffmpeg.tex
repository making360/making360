...
Since the FFmpeg bin folder has been added to the system's Environment PATH varialbe, you will now be able to run FFmpeg just by typing in "ffmpeg" or "ffmpeg.exe" in a new Command Prompt window.
