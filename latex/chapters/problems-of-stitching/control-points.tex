...
Refer to the Optimization Settings to understand the RMS value. Videos are stitched or linked together through the use of points that can be added manually or auto-detected. The points are then cleaned up with Autopano’s optimizer engine. Should you add points manually or auto-detect them?
