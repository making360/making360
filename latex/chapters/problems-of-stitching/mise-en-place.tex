...
Every step along the pipeline will process and distort your colors, decreasing the potential for highest quality picture. Your eyes may not be able to see, look at the changes in unique number of colors and RGB histograms via GMIP. They will be drastically affected depending on your setup and plugins for effects and color grading.
