...
Note the fontfile path on Windows needs to have each of the directory slashes like \\ esscaped with a double slash \\\\, and the colon in the C\: drive letter needs to be escaped with a slash as well.
