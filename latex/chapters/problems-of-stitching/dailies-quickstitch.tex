...
\blurb{You need to quickly stitch some source footage with burnt in timecode for a review session but don't know where to start.}
...
\blurb{Organizing a project folder}
...
\blurb{Quick stitching of takes}
...
\blurb{Encoding a burnt-in timecode}
