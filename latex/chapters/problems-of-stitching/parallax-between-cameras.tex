\chapter{Parallax between Cameras}
\pagecolor{white}
\label{chap:37}
\begin{fullwidth}
...
Head back to AVP and select a frame a few frames after the previous one, then click Edit again. In APG, repeat the previous actions but adding a “keep” marker on the other camera. Remove the previously placed marker. Don’t forget to always apply your changes with the green check icon, and save your stitch template for each edited keyframe.
