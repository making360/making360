...
\\
Kite and Lightning’s Insurgent VR utlized a pre-rendered static headless, neck-down 3D man model that was then composited on a live-rendered 360 video. This approach seems pretty complex to achieve but with the use of Andrew Hazelden's Domemaster3D in Maya or Blender's built-in LatLong renderer, any 3D artist can quickly buy a 3D model, render it out to LatLong mono or stereo and comp it in AE later.
