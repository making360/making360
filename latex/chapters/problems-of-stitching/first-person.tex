...
\\
Try compositing a 3D body model on top of your rendered live action 360 video. This approach seems pretty complex to achieve but with the use of Andrew Hazelden's DomeMaster in Maya or Blender's built-in LatLong renderer, any artist can model or buy a 3D model and render its LatLong mono or stereo to comp in AE later. 
